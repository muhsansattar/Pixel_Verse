...
const serverUrl = "https://kivt14y98mje.usemoralis.com:2053/server";
const appId = "83Reu8JlXgzEg9V1drN0OADuopa08eCSPLXz4czs";

const contractAddress = "0x47C3BDa2F7Aa115d38B20b8b636B184152Dca770";
const abi = [
	{
		"inputs": [],
...
async function isPlotAssignable(plotID) {
...
async function assignPlot() {
  ...
  const assigned = await isPlotAssignable(plotID);
  if (!assigned) {
      const metadata = {
          "PlotID":plotID,
